...
a persistence unit "prub64verdugoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prub64verdugo/pom.xml":
...
artifact ("prub64verdugo.war") is already built. You can build
